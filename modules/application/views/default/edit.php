...
$this->title = 'Edit Application Online | '.Yii::$app->params["company_name"].'';
?>
<style type="text/css">
  .selectpicker{
...
<section id="content" ng-controller="ApplicationEditController" ng-cloak>
  ...
  <div class="content-wrap" ng-show="hasItem && !isLoading && approval.status=='true'">
    <div class="container clearfix">
      <div class="col_full">
        <div class="error404 center">Approved</div>
      </div>
    </div>
  </div>
  <div class="content-wrap" ng-show="hasItem && !isLoading && approval.status=='false'">
    <form>
    <div class="container clearfix">
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
          <center>
            <button class="button button-3d button-large" ng-click="UpdateNow()">
              <i ng-class="(processing)?'icon-cog icon-spin':''"></i> Update Application
            </button>
          </center>
        </div>
        <div class="clear bottommargin"></div>
