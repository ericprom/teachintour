...
$this->title = 'Add New Pricing | '.Yii::$app->params["company_name"].'';
?>
<div id="page-menu">
  <div id="page-menu-wrap">
    <div class="container clearfix">
      <div class="menu-title">Add New <span>Pricing</span></div>
    </div>
  </div>
</div>
<section id="content" ng-controller="SettingFeeAddController" ng-cloak>
  <div class="content-wrap">
    <div class="container clearfix">
      ...
      <div class="col_full">
        <p>Flexible costing? Add a new pricing to make the diffent now.</p>
        ...
        <div class="col_full nobottommargin">
          <button class="button button-3d button-black nomargin" ng-click="saveNewPrice()">Save Now</button>
        </div>
      </div>
    </div>
  </div>
