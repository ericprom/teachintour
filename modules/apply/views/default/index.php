        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
          ...
          <form id="personal-form" name="personal-form" class="nobottommargin" action="#" method="post">
            <div class="col_half">
              ...
              <input type="text" id="personal-form-name" class="sm-form-control" />
            </div>
            <div class="col_half col_last">
              <label for="personal-form-lname">Last Name</label>
              <input type="text" id="personal-form-lname" class="sm-form-control" />
            </div>
            <div class="clear"></div>
            <div class="col_one_third ">
              <label for="personal-form-nationality">Nationality</label>
              <input type="text" id="personal-form-nationality" class="sm-form-control" />
            </div>
            <div class="col_one_third">
            ...
            <div class="col_two_third">
              ...
              <input type="text" id="personal-form-email" class="sm-form-control" />
            </div>
            <div class="col_one_third col_last">
              <label for="personal-form-phone">Phone number</label>
              <input type="text" id="personal-form-phone" class="sm-form-control" />
            </div>
            <div class="col_one_third ">
              <label for="personal-form-line">LINE ID</label>
              <input type="text" id="personal-form-line" class="sm-form-control" />
            </div>
            <div class="col_one_third">
              <label for="personal-form-facebook">Facebook</label>
              <input type="text" id="personal-form-facebook" class="sm-form-control" />
            </div>
            <div class="col_one_third col_last">
              <label for="personal-form-skype">Skype</label>
              <input type="text" id="personal-form-skype" class="sm-form-control" />
            </div>
            <div class="clear"></div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12">
          ...
          <div class="col_full">
            ...
            <input type="text" id="address-form-address" class="sm-form-control" />
          </div>
          <div class="col_half ">
            <label for="address-form-city">City</label>
            <input type="text" id="address-form-city" class="sm-form-control" />
          </div>
          <div class="col_half col_last">
            <label for="address-form-state">State</label>
            <input type="text" id="address-form-state" class="sm-form-control" />
          </div>
          <div class="clear"></div>
          <div class="col_half">
            <label for="address-form-zipcode">Zipcode</label>
            <input type="text" id="address-form-zipcode" class="sm-form-control" />
          </div>
          <div class="col_half col_last">
            <label for="address-form-country">Country</label>
            <input type="text" id="address-form-country" class="sm-form-control" />
          </div>
          <div class="clear"></div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
          ...
          <div class="col_full">
            ...
            <textarea class="sm-form-control" id="personal-form-education" rows="6" cols="30"></textarea>
          </div>
          <div class="col_full">
            <label for="personal-form-experiences">Volunteer/Work Experiences</label>
            <textarea class="sm-form-control" id="personal-form-experiences" rows="6" cols="30"></textarea>
          </div>
          <div class="col_full">
            <label for="personal-form-language">Language Ability</label>
            <textarea class="sm-form-control" id="personal-form-language" rows="6" cols="30"></textarea>
          </div>
          <div class="col_full">
            <label for="personal-form-skills">Special Skills</label>
            <textarea class="sm-form-control" id="personal-form-skills" rows="6" cols="30"></textarea>
          </div>
        </div>
        <div class="clear bottommargin"></div>
      </div>
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
          ...
          <div class="col_full">
            ...
            <textarea class="sm-form-control" id="personal-form-contact" rows="6" cols="30"></textarea>
          </div>
        </div>
        <div class="clear bottommargin"></div>
      </div>
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
          ...
          <div class="col_full">
            ...
            <div>
              <input id="radio-1" class="radio-style" name="radio-group-1" type="radio">
              <label for="radio-1" class="radio-style-2-label">Yes</label>
            </div>
            <div>
              <input id="radio-2" class="radio-style" name="radio-group-1" type="radio" checked>
          ...
          <div class="col_full">
            ...
            <div>
              <input id="radio-3" class="radio-style" name="radio-group-2" type="radio">
              <label for="radio-3" class="radio-style-2-label">Yes</label>
            </div>
            <div>
              <input id="radio-4" class="radio-style" name="radio-group-2" type="radio" checked>
